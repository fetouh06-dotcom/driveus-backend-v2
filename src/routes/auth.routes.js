 ...
 *
 * Par défaut, désactivé en production (anti-spam). Pour l’activer :
 *   ALLOW_PUBLIC_REGISTER=true
 */
router.post("/register", registerLimiter, validateLogin, async (req, res) => {
  try {
    if (config.NODE_ENV === "production" && !config.ALLOW_PUBLIC_REGISTER) {
